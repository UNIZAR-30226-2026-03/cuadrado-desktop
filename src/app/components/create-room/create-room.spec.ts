  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: VoiceChatService, useValue: { requestPermissionAndLoadDevices: () => Promise.resolve(false), micPermission: { subscribe: () => {} }, audioInputDevices: () => [], localStream: () => null, selectedDeviceId: () => 'default', outputVolume: () => 80, sfxVolume: () => 80, micMuted: () => false, localSpeaking: () => false, speakingPeers: () => new Set(), connectedPeers: () => [], mutedPeers: () => new Set(), selfMutedPeers: () => new Set() } },
      ],
    }).compileComponents();
